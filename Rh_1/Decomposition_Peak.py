...
def SoilDecom_real (u,theta,ymax,sample_site,t,obser_data,Nmin,potimm,flag_SMB1,flag_SMB2,Rh,lig_p1,lig_p2,     #Scalar(7)#  ###QQQ: 20210908: add 2 logistic lignin para to control lignin decomposition
                    AOM1,AOM2,AOM3,SMB1,SMB2,SMR,NOM,MOM,avN,initCont,litligsoil_CO2,#Class(10)#                    # 20220310(3):u,delta.,ymax for second peak###
